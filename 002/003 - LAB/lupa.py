...
def setup():
    global img
    py5.size(800, 400)
    img = py5.load_image("001 - py5/img/imagen.jpg")  # Usá una imagen disponible en tu carpeta img/
    img.resize(400, 400)
...
def draw():
    ...
    mx = py5.mouse_x #variacion
    my = py5.mouse_y #variacion
    ...
    #py5.fill(color_pixel) original
    #py5.fill(255 - r, 255 - g, 255 - b) #variacion
    py5.fill(r, 0, 0) #variacion 2
    py5.stroke(0)
